                ...
                <b>
                    ...
                    <select name="faculty_id" id="faculty_id" class="p-2" style="width:100px;">
                        ...
                        <?php foreach($res as $faculty):?>
                            <option value="<?=$faculty['id']?>"><?=strtoupper($faculty['lname'].', '.$faculty['fname'])?></option>
                        <?php endforeach;?>
                    </select>
                </b>
                SUBJECT : 
...
function printDiv() 
{
    ...
    var body = '';
    var prepared_by = 'Prepared by: <br /><br /><b><?=strtoupper($_SESSION['USER_NAME'])?></b> <br /><?=date('F j, Y h:i a')?>';
    print.document.open();
