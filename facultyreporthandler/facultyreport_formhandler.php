...
@include '../facultyreporthandler/facultyreport_eventhandler.php';

$_conn = new ConnectionHandler();
$_facultyreport = new FacultyReport($_conn);
...
if (isset($_POST["btnsave"])) {
  ...
  echo ($_facultyreport->addFacultyReport($fk_student_id,  $fk_student_name)) ?
